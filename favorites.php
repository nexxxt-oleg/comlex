...
?>
    ...
    <div class="container">
        ...
        <div class="d-lg-flex d-xl-flex d-block align-items-center justify-content-between fpad30">
            <h1 class="complex__title pb-0">Избранное</h1>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 fpad30">
                <div class="complex__products__item complex__products__item--grid">
                    <div class="complex__products__item__wrapper complex__product">
                        ...
                        <div class="complex__products__item__del">
                            <a href="" class="d-flex align-items-center all-clear justify-content-center">
                                <svg width="13" height="13" class="ico mr-10">
                                    <use xlink:href="#svg-close"></use>
                                </svg>
